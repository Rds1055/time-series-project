...
tsplot(
  nfl.cumulative.ts, 
  main = "NFL Total Attendance Over Time",
...
```{r}
# sarimaModel = sarima(nfl.training.ts, p=3, d=0, q=1, P=2, D=1, Q=1, S=17, details = FALSE)
# sarimaForecast = sarima.for(nfl.training.ts, n.ahead = 17, p=3, d=0, q=1, P=2, D=1, Q=1, S=17, plot = FALSE)
